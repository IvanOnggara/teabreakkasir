...
<script type="text/javascript" src=<?php echo base_url("assets/vendors/pdf.js")?>></script>
<script type="text/javascript" src=<?php echo base_url("assets/vendors/pdf.worker.js")?>></script>
...
//     // var pembatas2 = pembatas1+24;
//     var pembatas3 = pembatas2+21;
//     var doc = new jsPDF('p', 'mm', [pembatas3+15, 48]);
...
//         doc.text('topping : '+order[i]['topping'].toString(), 2, pembatas2help+3);
//         doc.text('@ Rp.'+currency(hargatotsatuan)+',-', 2, pembatas2help+6);
//         doc.text(currency(order[i]['total'])+',-', 46, pembatas2help+3,'right');
...
//     doc.text($("#subtotal").html().replace('Rp ','')+',-', 46, pembatas2+3,'right');
//     doc.text($("#diskon").html().replace('Rp ','')+',-', 46, pembatas2+7,'right');
//     doc.text($("#total_bayar").html()+',-', 46, pembatas2+11,'right');
//     doc.text('--------------------', 46, pembatas2+14,'right');
//     doc.text($("#kembalian").html().replace('Rp ','')+',-', 46, pembatas2+17,'right');
